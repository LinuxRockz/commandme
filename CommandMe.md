...
# GITEA_RAW_URL  = "https://git.yourdomain.com/username/repo/raw/branch/main/commandme.py"
...
- Support for **both GitHub and Gitea**
- `UPDATE_PLATFORM = "github"` (or change to `"gitea"`)
- Two raw URLs: `GITHUB_RAW_URL` and `GITEA_RAW_URL`
- New option **`p`** → Switch Platform (GitHub ↔ Gitea)
- Platform name shown in the menu header
- Choice is saved in the config file

**How to use with Gitea:**

1. Set `UPDATE_PLATFORM = "gitea"`
2. Update `GITEA_RAW_URL` to your instance, e.g.:
   `https://git.yourcompany.com/username/my-repo/raw/branch/main/commandme.py`
3. (Optional) Keep GitHub URL for easy switching

Just upload this script to your chosen platform and you’re good to go!

Would you like a one-time setup wizard or any other tweak?